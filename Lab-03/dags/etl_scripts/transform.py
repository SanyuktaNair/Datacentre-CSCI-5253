...
def prep_data(data):
    ...
    data['sex'] = data['sex'] = data['sex_upon_outcome'].replace({"Neutered Male":"M",
                                                    "Intact Male":"M", 
                                                    "Intact Female":"F", 
                                                    "Spayed Female":"F", 
                                                    "Unknown":np.nan})
...
def prep_animal_dim(data):
    ...
    animal_dim = data[['animal_id', 'name', 'date_of_birth', 'sex_upon_outcome', 'animal_type', 'breed', 'color']]

    
    # rename the columns to agree with the DB tables
    animal_dim.columns = ['animal_id', 'name', 'date_of_birth', 'sex', 'animal_type', 'breed', 'color']
